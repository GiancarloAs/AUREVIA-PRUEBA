...
const ICONS = {
  ...
  tip: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.5.4.8 1 .8 1.6h5.4c0-.6.3-1.2.8-1.6A6 6 0 0 0 12 3z"/></svg>`,

  train: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="5" y="3.5" width="14" height="12" rx="3"/><line x1="5" y1="11" x2="19" y2="11"/><circle cx="8.5" cy="17.5" r="1"/><circle cx="15.5" cy="17.5" r="1"/><path d="M8 19.5L6 22M16 19.5l2 2.5"/></svg>`
};
